...
//       tebe[a].setKuncipintudanjendela(in.next());
      ...
      String AnalisisData (){
         if (tebe[a].jumlahpintu>=2){ 
          ...
          if (tebe[a].jumlahjendela>=1){ // kondisi ruang kelas
            System.out.println("Sesuai");
        }
        else {
            System.out.println("Tidak sesuai");
            ...
            if (tebe[a].jumlahstopkontak>=4){ // jumlah,kondisi,posisi sarana
            System.out.println("Sesuai");
        }
        else {
            System.out.println("Tidak sesuai");
   ...
   if (tebe[a].pilihSSID.equals("UMM Hotspot")){
       ...
       if (tebe[a].posisiCCTV.equals("Depan") && tebe[a].posisiCCTV.equals("Belakang")){
        ...
        int b = in.nextInt();
           ...
           if (tebe[a].inputsirkulasiudara.equals("Lancar")){ // kebersihan ruang kelas
            System.out.println("Sesuai");
        }
        else {
            System.out.println("Tidak sesuai");
